...
1. Clone the repository: `git clone https://github.com/isaSanchez-png/Tip-Calculator.git`
...
1. Clona el repositorio: `git clone https://github.com/isaSanchez-png/Tip-Calculator.git`
